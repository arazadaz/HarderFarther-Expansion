...
public class SyncDifficultyToClientsPacket  {
		...
		public static SyncDifficultyToClientsPacket readPacketData(PacketByteBuf buf) {
		...
		public static void writePacketData(SyncDifficultyToClientsPacket msg, PacketByteBuf buf)
		{
			msg.encode(buf);
		}
